    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-10 md:py-14 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur rounded-full px-3 py-1 text-xs md:text-sm font-medium mb-3 border border-white/20">
            <Flame className="h-3.5 w-3.5 text-orange-400" /> 限量商城 · 台幣購買 · 點數折抵
          </div>
          <h1 className="text-2xl md:text-5xl font-black mb-2 tracking-tight leading-tight">🌲 回音樹 限量商城</h1>
          <p className="text-emerald-200 text-sm mb-5 max-w-lg mx-auto">
            限定周邊、ESG 紀念品 — 點數可折抵 10%
          </p>
      ...
      {/* ── Product grid ───────────────────────────────────────────── */}
      <div className="container mx-auto px-3 md:px-4 py-5">
            ...
            return (
              ...
              >
                ...
                <div className="p-2.5 sm:p-3">
                  <div className="font-bold text-gray-900 text-[13px] leading-snug mb-1 line-clamp-2">{item.name}</div>
                  <div className="text-[11px] text-gray-400 line-clamp-1 mb-2 leading-relaxed">{item.description}</div>
                  <div className="flex items-end justify-between">
                    <div className="text-emerald-600 font-black text-sm leading-none">{fmt(item.points)}</div>
                    <div className="text-[11px] text-gray-400">剩 {item.stock}</div>
                  </div>
                </div>
              </div>
            )
